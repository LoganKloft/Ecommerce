        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderDate = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false),
                    RequiredDate = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false),
                    FinalShipDate = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false),
                    ...
                    FinalPaymentDate = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false),
                    LastPaymentDate = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false),
                    BillDate = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Expiry = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitSize = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventories_Discounts_DiscountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InventoryId = table.Column<int>(type: "integer", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    ShippedOn = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false),
                    ShipBy = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_DiscountId",
                table: "Inventories",
                column: "DiscountId");
